    ...
    <div className="max-w-[1280px] m-auto min-h-[70vh] p-3 pt-28 pb-20">
      <div className="w-full xs:py-20 py-10 flex md:gap-10 gap-5"> 
        ...
        <div className="md:w-1/2 w-full m-auto xs:px-20 px-2">
          <h1 className="text-4xl font-medium mb-2">Login To Stylezy</h1>
          ...
          <form action="" className="space-y-7 mt-10">
            ...
            <div className="flex justify-between items-center">
              <input
                type="submit"
                value="Log In"
                className="px-10 font-medium w-fit bg-myHeading text-white py-3 rounded-md"
              />
              <span className="text-myHeading">Forget Password?</span>
            </div>
          </form>
